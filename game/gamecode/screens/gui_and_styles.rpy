...
define gui.hyperlink_text_color = '#E470B2'
...
define gui.hover_selected_color = '#E470B2'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#E470B2'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#855F75'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#3F0056'
define gui.hover_muted_color = '#855F75'
...
define gui.name_text_size = gui.preference("name_size", 36)
## The size of text in the game's user interface.
define gui.interface_text_size = gui.preference("interface_size", 32)
## The size of labels in the game's user interface.
define gui.label_text_size = gui.preference("label_size", 38)
## The size of text on the notify screen.
define gui.notify_text_size = gui.preference("notify_size", 16)
## The size of the game's title.
define gui.title_text_size = gui.preference("title_size", 45)

define gui.text_outlines = [(2, "#000000bf", 0, 0)]
define gui.quick_button_text_outlines = [(1, "#000000bf", 0, 0)]
...
define gui.button_borders = Borders(0, 0, 0, 0) # have to cut off top and bottom padding for lists
...
define gui.radio_button_borders = Borders(7, 5, 0, 5)

define gui.check_button_borders = Borders(48, 8, 0, 8)

define gui.navigation_button_borders = Borders(0, 6, 0, 6)
...
define gui.slot_button_width = 326
...
## Controls the amount of spacing between Options.
...
define gui.history_text_xpos = 0.15
...
style tab:
    padding(10, 5, 10, 0)
    xminimum 150
    idle_background Frame("gui/tab_idle.png")
    hover_background Frame("gui/tab_hover.png")
    insensitive_background Frame("gui/tab_selected.png")
    selected_background Frame("gui/tab_selected.png")

style tab_outline:
    padding(10, 5, 10, 0)
    xminimum 100
    idle_background Frame("gui/tab_idle_outline.png")
    hover_background Frame("gui/tab_hover_outline.png")
    selected_background Frame("gui/tab_selected.png")
    insensitive_background Frame("gui/tab_selected.png")
...
style text_small_tab:
    size 22
    xalign 0.5

style bottom_frame:
    background Frame("gui/framedivider256.png")
...
style radio_label is gui_label

style radio_label_text is gui_label_text

style radio_vbox is vbox

style check_vbox is vbox
...
style check_label is gui_label
...
style slider_label is gui_label:
...
style gui_green_text is gui_button_text:
    idle_color "#34C147"
